...
The following features are on the **container** level:
...
- Environment variables is defined on the **container** level
```
apiVersion: v1
kind: Pod
metadata: 
...
- Environment variables can be defined by **configMap**
...
- Environment variables can be defined by **secret**
```
apiVersion: v1
kind: Pod
metadata: 
